...
export function HeroSvg() {
  return (
    <svg className="hero-video" viewBox="0 0 1600 900" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <defs><linearGradient id="sky" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stopColor="#FFB88C"/><stop offset="0.5" stopColor="#E89E7C"/><stop offset="1" stopColor="#1A3A52"/></linearGradient></defs>
